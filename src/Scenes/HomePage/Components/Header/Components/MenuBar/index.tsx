  ...
  render() {
    ...
    return (
      <div className="menuBar">
        <div className="langSelectorWrapper">{/* <LanguageSelector /> */}</div>
        <a href="/">
        ...
        <a
          href="#"
          className={
            'homeNavHandler visible-xs' +
            (this.state.isHandlerActive ? ' active' : '')
          }
        ...
        <div
          className={'homeNav' + (this.state.isHandlerActive ? ' active' : '')}
        >
          <ul>
            <li className="moreOption">
              <Link to="/search?type=sale">
                {getTranslation(this.props.lang, 'Buy')}
              </Link>
            </li>
            <li className="moreOption">
              <Link to="/search?type=rent">
                {getTranslation(this.props.lang, 'Rent')}
              </Link>
            </li>
            <li className="moreOption">
              <Link to="/agent/search">
                {getTranslation(this.props.lang, 'Renovation')}
              </Link>
            </li>
            <li className="moreOption">
              <Link to="/agent/search">
                {getTranslation(this.props.lang, 'Commercial')}
              </Link>
            </li>
            <li className="moreOption">
              <Link to="/projects">
                {getTranslation(this.props.lang, 'Project')}
              </Link>
            </li>
            <li className="moreOption">
              <Link to="/agent/search">
                {getTranslation(this.props.lang, 'Find agent')}
              </Link>
            </li>
            {this.loginField()}
            <li>
